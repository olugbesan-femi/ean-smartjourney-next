...
export default function ChatModal({
  open,
  onClose,
  seed, // optional: pre-seed an intent e.g. "Generate lounge access QR"
}: {
  open: boolean;
  onClose: () => void;
  seed?: string;
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      text:
        "Hi, I'm your EAN AI Concierge 🤖 — I can arrange transport, generate your access QR, or share your latest invoice. What do you need?",
    },
  ]);
  ...
  const send = (text: string) => {
    ...
    setMessages((prev) => [
      ...
      { role: "assistant", text: respond(clean) },
    ]);
  };
